...
if [ ! -z ${p_patch} ] ; then
  ...
  do
    ...
    curl -b $COOK -c $COOK --tlsv1 --insecure --user-agent "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_0) AppleWebKit/601.7.7 (KHTML, like Gecko) Version/9.1.2 Safari/601.7.7" --output $fname -L "$URL"
